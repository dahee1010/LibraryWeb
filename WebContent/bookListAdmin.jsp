			...
			<table class="tab2">
				<tr>
					<td align="center"><c:if test="${startPage > pageBlock}">
							<a href="bookListAdmin.do?page=1">[맨앞으로]</a>
							<a href="bookListAdmin.do?page=${startPage-10}">[이전]</a>
							...
							<a href="bookListAdmin.do?page=${startPage+10}">[다음]</a>
							<a href="bookListAdmin.do?page=${pageCount}">[맨뒤로]</a>
						</c:if></td>
				</tr>
			</table>
		</div>
